...
<span style="text-align: center;"> Add Questions </span> <svg style="color:#0023ff " width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div class="container mt-5 bg-white shadow-lg " style="text-align: center; border-radius: 15px;">
  ...
  <h4 style="text-align: center;" class="mt-4">Select Detail and Add Question</h4>
  <a class="btn btn-primary" onclick=" window.open('https://wordhtml.com/','_blank')">Refer Word to HTML converter</a>
      <form method="post" action="add_que_to_bank.php">
  <div class="row">
            <div class="col-sm-2 ">
...
<form method="post" action="add_que_to_bank.php">
            ...
            <div class="col-sm-4 mb-4 mt-3" >
              <form method="post" action="add_que_code.php">
              ...
              <select name='q_level' class='form-control'>
                ...
                <option value="3">III</option>
                 ...
                 <div class="col-sm-3 mt-4">
                  <button class="btn btn-block btn-primary mt-4">Add Question</button>
                 </div>
                 <div class="col-sm-6" style="padding: 15px;">
                  <h4 style="text-align: center;">Question <span style="color: red">*</span></h4>
                  <textarea required name="question" style="border-style: solid;border-width: 1px;width: 100%;border-color: grey;height: 200px;padding: 10px;font-size: 14px;"></textarea>
                 </div>
                 <div class="col-sm-6" style="padding: 15px;">
                  <h4 style="text-align: center;">Solution <span style="color: red">*</span></h4>
                  <textarea required name="solution" style="border-style: solid;border-width: 1px;width: 100%;border-color: grey;height: 200px;font-size: 14px;padding: 10px;"></textarea>
                </form>
                 </div>
               </div>
             </div>
